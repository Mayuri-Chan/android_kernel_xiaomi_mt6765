...
#ifndef _CEREUS_S5K5E8YXAUX_OFILM_SENSOR_H
#define _CEREUS_S5K5E8YXAUX_OFILM_SENSOR_H
...
struct imgsensor_info_struct {
	...
	struct imgsensor_mode_struct pre; // preview
	struct imgsensor_mode_struct cap; // capture
	struct imgsensor_mode_struct cap1; // capture for PIP 24fps
	struct imgsensor_mode_struct cap2; // capture for PIP 15fps
	struct imgsensor_mode_struct normal_video; // normal video
	struct imgsensor_mode_struct hs_video; // high speed video
