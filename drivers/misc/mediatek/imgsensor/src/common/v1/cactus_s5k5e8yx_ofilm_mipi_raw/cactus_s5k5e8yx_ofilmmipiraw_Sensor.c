...
#include "cactus_s5k5e8yx_ofilmmipiraw_Sensor.h"
#include "cam_cal_define.h"

/****************************Modify following Strings for debug****************************/
#define PFX "cactus_s5k5e8yx_ofilm_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = { 
	.sensor_id = CACTUS_S5K5E8YX_OFILM_SENSOR_ID,
	...
	.isp_driving_current = ISP_DRIVING_4MA,  //6MA
...
static struct stCAM_CAL_DATAINFO_STRUCT sensor_eeprom_data ={
	.sensorID= CACTUS_S5K5E8YX_OFILM_SENSOR_ID,
	.deviceID = 0x02,
	.dataLength = 386,
...
static kal_uint16 cactus_s5k5e8yx_ofilm_table_write_cmos_sensor(
 ...
 *************************************************************************/
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_cactus_s5k5e8yx_ofilm[] = {
	0x0100, 0x00,
	0x3906, 0x7E,
	0x3C01, 0x0F,
	0x3C14, 0x00,
...
static void sensor_init(void)
{
	...
	cactus_s5k5e8yx_ofilm_table_write_cmos_sensor(
		addr_data_pair_init_cactus_s5k5e8yx_ofilm,
		sizeof(addr_data_pair_init_cactus_s5k5e8yx_ofilm) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_cactus_s5k5e8yx_ofilm[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
#if MULTI_WRITE
	cactus_s5k5e8yx_ofilm_table_write_cmos_sensor(
		addr_data_pair_preview_cactus_s5k5e8yx_ofilm,
		sizeof(addr_data_pair_preview_cactus_s5k5e8yx_ofilm) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_cactus_s5k5e8yx_ofilm[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
kal_uint16 addr_data_pair_capture_24fps_cactus_s5k5e8yx_ofilm[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
kal_uint16 addr_data_pair_capture_30fps_cactus_s5k5e8yx_ofilm[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
	cactus_s5k5e8yx_ofilm_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_cactus_s5k5e8yx_ofilm,
		sizeof(addr_data_pair_capture_15fps_cactus_s5k5e8yx_ofilm) /
		sizeof(kal_uint16));
	} else if (currefps == 240) {
	cactus_s5k5e8yx_ofilm_table_write_cmos_sensor(
		addr_data_pair_capture_24fps_cactus_s5k5e8yx_ofilm,
		sizeof(addr_data_pair_capture_24fps_cactus_s5k5e8yx_ofilm) /
		sizeof(kal_uint16));
	} else {
	cactus_s5k5e8yx_ofilm_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_cactus_s5k5e8yx_ofilm,
		sizeof(addr_data_pair_capture_30fps_cactus_s5k5e8yx_ofilm) /
		sizeof(kal_uint16));
	}
#else
	if (currefps == 150){
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_cactus_s5k5e8yx_ofilm[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
#if MULTI_WRITE
	cactus_s5k5e8yx_ofilm_table_write_cmos_sensor(
		addr_data_pair_hs_video_cactus_s5k5e8yx_ofilm,
		sizeof(addr_data_pair_hs_video_cactus_s5k5e8yx_ofilm) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0136,0x18);
	write_cmos_sensor(0x0137,0x00);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_cactus_s5k5e8yx_ofilm[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
#if MULTI_WRITE
cactus_s5k5e8yx_ofilm_table_write_cmos_sensor(
	addr_data_pair_slim_video_cactus_s5k5e8yx_ofilm,
	sizeof(addr_data_pair_slim_video_cactus_s5k5e8yx_ofilm) /
	sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0136,0x18);
	write_cmos_sensor(0x0137,0x00);
...
#define S5K5E8YX_OFILM_FRONT_I2CBUS    (4)
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
	...
	LOG_DBG("S5K5E8YX_OFILM_FRONT_I2CBUS = %d, I2C_bus = %d\n", S5K5E8YX_OFILM_FRONT_I2CBUS, I2C_bus);
	if (I2C_bus != S5K5E8YX_OFILM_FRONT_I2CBUS) {
		*sensor_id = 0xFFFFFFFF;
		LOG_ERR("S5K5E8YX_OFILM_FRONT_I2CBUS: %d, I2C_bus = %d, Check Error!\n", S5K5E8YX_OFILM_FRONT_I2CBUS, I2C_bus);
