...
#include "cereus_s5k5e8yxaux_sunny_mipiraw_Sensor.h"
#include "../imgsensor_i2c.h"
#include "cam_cal_define.h"

/****************************Modify following Strings for debug****************************/
#define PFX "cereus_s5k5e8yxaux_sunny_mipiraw_sensor"
...
static struct imgsensor_info_struct imgsensor_info = { 
	.sensor_id = CEREUS_S5K5E8YXAUX_SUNNY_SENSOR_ID,
...
{{ 2592, 1944,	  0,	0, 2592, 1944, 1296,  972, 0000, 0000, 1296,  972,	  0,	0, 1296,  972}, // Preview 
 ...
 { 2592, 1944,	  16, 252, 2560, 1440,  640,  480, 0000, 0000,  640,  480,	  0,	0,  640,  480}, //hight speed video 
 { 2592, 1944,	  16,  12, 2560, 1920, 1280,  720, 0000, 0000, 1280,  720,	  0,	0, 1280,  720}, // slim video
 { 2592, 1944,	  0,	0, 2592, 1944, 1296,  972, 0000, 0000, 1296,  972,	  0,	0, 1296,  972}, // custom1
 { 2592, 1944,	  0,	0, 2592, 1944, 2592, 1944, 0000, 0000, 2592, 1944,	  0,	0, 2592, 1944}};  //custom2

static struct stCAM_CAL_DATAINFO_STRUCT sensor_eeprom_data ={
	.sensorID= CEREUS_S5K5E8YXAUX_SUNNY_SENSOR_ID,
	.deviceID = 0x04,
	.dataLength = 386,
	.sensorVendorid = 0x012AFFFF,
	.vendorByte = {1,8,9,10},
	.dataBuffer = NULL,
};
...
static kal_uint16 cereus_s5k5e8yxaux_sunny_table_write_cmos_sensor(
 ...
 *************************************************************************/
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_cereus_s5k5e8yxaux_sunny[] = {
	0x0100, 0x00,
	0x3906, 0x7E,
	0x3C01, 0x0F,
	0x3C14, 0x00,
...
static void sensor_init(void)
{
	...
	cereus_s5k5e8yxaux_sunny_table_write_cmos_sensor(
		addr_data_pair_init_cereus_s5k5e8yxaux_sunny,
		sizeof(addr_data_pair_init_cereus_s5k5e8yxaux_sunny) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_preview_cereus_s5k5e8yxaux_sunny[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
#if MULTI_WRITE
	cereus_s5k5e8yxaux_sunny_table_write_cmos_sensor(
		addr_data_pair_preview_cereus_s5k5e8yxaux_sunny,
		sizeof(addr_data_pair_preview_cereus_s5k5e8yxaux_sunny) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_capture_15fps_cereus_s5k5e8yxaux_sunny[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
static kal_uint16 addr_data_pair_capture_24fps_cereus_s5k5e8yxaux_sunny[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
static kal_uint16 addr_data_pair_capture_30fps_cereus_s5k5e8yxaux_sunny[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
	cereus_s5k5e8yxaux_sunny_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_cereus_s5k5e8yxaux_sunny,
		sizeof(addr_data_pair_capture_15fps_cereus_s5k5e8yxaux_sunny) /
		sizeof(kal_uint16));
	} else if (currefps == 240) {
	cereus_s5k5e8yxaux_sunny_table_write_cmos_sensor(
		addr_data_pair_capture_24fps_cereus_s5k5e8yxaux_sunny,
		sizeof(addr_data_pair_capture_24fps_cereus_s5k5e8yxaux_sunny) /
		sizeof(kal_uint16));
	} else {
	cereus_s5k5e8yxaux_sunny_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_cereus_s5k5e8yxaux_sunny,
		sizeof(addr_data_pair_capture_30fps_cereus_s5k5e8yxaux_sunny) /
		sizeof(kal_uint16));
	}
#else
	if (currefps == 150){
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_hs_video_cereus_s5k5e8yxaux_sunny[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
#if MULTI_WRITE
	cereus_s5k5e8yxaux_sunny_table_write_cmos_sensor(
		addr_data_pair_hs_video_cereus_s5k5e8yxaux_sunny,
		sizeof(addr_data_pair_hs_video_cereus_s5k5e8yxaux_sunny) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0136,0x18);
	write_cmos_sensor(0x0137,0x00);
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_slim_video_cereus_s5k5e8yxaux_sunny[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
#if MULTI_WRITE
cereus_s5k5e8yxaux_sunny_table_write_cmos_sensor(
	addr_data_pair_slim_video_cereus_s5k5e8yxaux_sunny,
	sizeof(addr_data_pair_slim_video_cereus_s5k5e8yxaux_sunny) /
	sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0136,0x18);
	write_cmos_sensor(0x0137,0x00);
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_custom1_cereus_s5k5e8yxaux_sunny[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
static kal_uint16 addr_data_pair_custom2_cereus_s5k5e8yxaux_sunny[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
static void custom1_setting(void)
{
	// +++++++++++++++++++++++++++//                                                               
	// Reset for operation                                                                         
	LOG_DBG("E! custom1_setting\n");
	//$MV1[MCLK:24,Width:1296,Height:792,Format:MIPI_RAW10,mipi_lane:2,mipi_datarate:836,pvi_pclk_inverwrite_cmos_sensor(0xe:0]);
	//Extclk_frequency_mhz
#if MULTI_WRITE
	cereus_s5k5e8yxaux_sunny_table_write_cmos_sensor(
		addr_data_pair_custom1_cereus_s5k5e8yxaux_sunny,
		sizeof(addr_data_pair_custom1_cereus_s5k5e8yxaux_sunny) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0136,0x18);
	write_cmos_sensor(0x0137,0x00);
...
{
	LOG_DBG("E! custom2_setting\n");
#if MULTI_WRITE
	cereus_s5k5e8yxaux_sunny_table_write_cmos_sensor(
		addr_data_pair_custom2_cereus_s5k5e8yxaux_sunny,
		sizeof(addr_data_pair_custom2_cereus_s5k5e8yxaux_sunny) /
		sizeof(kal_uint16));
#else
	// Reset for operation     30fps for normal capture
	write_cmos_sensor(0x0136,0x18);
...
*
*************************************************************************/
#define CEREUS_S5K5E8YXAUX_SUNNY_I2CBUS    (6)
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
	...
	LOG_DBG("CEREUS_S5K5E8YXAUX_SUNNY_I2CBUS = %d, I2C_bus = %d\n", CEREUS_S5K5E8YXAUX_SUNNY_I2CBUS, I2C_bus);
	if (I2C_bus != CEREUS_S5K5E8YXAUX_SUNNY_I2CBUS) {
		*sensor_id = 0xFFFFFFFF;
		LOG_ERR("CEREUS_S5K5E8YXAUX_SUNNY_I2CBUS: %d, I2C_bus = %d, Check Error!\n", CEREUS_S5K5E8YXAUX_SUNNY_I2CBUS, I2C_bus);
	...
	switch (scenario_id) {
		...
		case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
        	  if (imgsensor.current_fps == imgsensor_info.cap1.max_framerate) {
				...
				if (imgsensor.current_fps != imgsensor_info.cap.max_framerate)
					LOG_ERR("Warning: current_fps %d fps is not support, so use cap's setting: %d fps!\n",framerate,imgsensor_info.cap.max_framerate/10);
			...
			UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	switch (feature_id) {
		...
		case SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ:
			LOG_DBG("feature_Control imgsensor.pclk = %d,imgsensor.current_fps = %d\n", imgsensor.pclk,imgsensor.current_fps);
