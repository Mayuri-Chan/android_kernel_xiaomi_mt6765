...
#include "cactus_ov13855_ofilm_Sensor.h"
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[] = {
	// preview
	{4256, 3168, 0, 8, 4256, 3152, 2128, 1576, 8, 4, 2112, 1568, 0, 0, 2112, 1568},
	// capture
	{4256, 3168, 0, 8, 4256, 3152, 4256, 3152, 16, 8, 4224, 3136, 0, 0, 4224, 3136},
	// video
	{4256, 3168, 0, 8, 4256, 3152, 4256, 3152, 16, 8, 4224, 3136, 0, 0, 4224, 3136},
	// high speed video
	{4256, 3168, 64, 64, 4128, 3104, 1032, 776, 196, 148, 640, 480, 0, 0, 640, 480},
	// slim video
	{4256, 3168, 64, 64, 4128, 3104, 1032, 776, 4, 4, 1024, 768, 0, 0, 1024, 768}
};
...
static struct stCAM_CAL_DATAINFO_STRUCT sensor_eeprom_data = {
	...
	.deviceID = 1,
	.dataLength = 0x1BF6,
	.sensorVendorId = 0x723160A,
	.vendorByte = {1, 8, 9, 10},
	.dataBuffer = NULL
};

static struct stCAM_CAL_CHECKSUM_STRUCT cactus_ov13855_ofilm_checksum[] = {
...
static void cactus_ov13855_ofilm_table_write_cmos_sensor(const kal_uint16 *para, kal_uint32 len) {
...
kal_uint16 addr_data_pair_init_cactus_ov13855_ofilm[] = {
	0x0300, 0x02,
	0x0301, 0x00,
	0x0302, 0x5a,
	0x0304, 0x00,
...
static void sensor_init(void) {
	cactus_ov13855_ofilm_table_write_cmos_sensor(addr_data_pair_init_cactus_ov13855_ofilm, sizeof(addr_data_pair_init_cactus_ov13855_ofilm) / sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_preview_cactus_ov13855_ofilm[] = {
	0x0303, 0x01,
	0x3501, 0x40,
	0x3662, 0x10,
	0x3714, 0x28,
...
static void preview_setting(void) {
	cactus_ov13855_ofilm_table_write_cmos_sensor(addr_data_pair_preview_cactus_ov13855_ofilm, sizeof(addr_data_pair_preview_cactus_ov13855_ofilm) / sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_capture_15fps_cactus_ov13855_ofilm[] = {
	0x0303, 0x00,
	0x3501, 0x80,
	0x3662, 0x12,
	0x3714, 0x24,
...
kal_uint16 addr_data_pair_capture_30fps_cactus_ov13855_ofilm[] = {
	0x0303, 0x00,
	0x3501, 0x80,
	0x3662, 0x12,
	0x3714, 0x24,
...
static void capture_setting(kal_uint16 current_fps) {
	if (current_fps == 150) {
		cactus_ov13855_ofilm_table_write_cmos_sensor(addr_data_pair_capture_15fps_cactus_ov13855_ofilm, sizeof(addr_data_pair_capture_15fps_cactus_ov13855_ofilm) / sizeof(kal_uint16));
	} else {
		cactus_ov13855_ofilm_table_write_cmos_sensor(addr_data_pair_capture_30fps_cactus_ov13855_ofilm, sizeof(addr_data_pair_capture_30fps_cactus_ov13855_ofilm) / sizeof(kal_uint16));
	}
}

kal_uint16 addr_data_pair_video_cactus_ov13855_ofilm[] = {
	0x0303, 0x00,
	0x3501, 0x80,
	0x3662, 0x12,
	0x3714, 0x24,
...
static void normal_video_setting(void) {
	cactus_ov13855_ofilm_table_write_cmos_sensor(addr_data_pair_video_cactus_ov13855_ofilm, sizeof(addr_data_pair_video_cactus_ov13855_ofilm) / sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_hs_video_cactus_ov13855_ofilm[] = {
	0x0303, 0x03,
	0x3501, 0x20,
	0x3662, 0x08,
	0x3714, 0x30,
...
static void hs_video_setting(void) {
	cactus_ov13855_ofilm_table_write_cmos_sensor(addr_data_pair_hs_video_cactus_ov13855_ofilm, sizeof(addr_data_pair_hs_video_cactus_ov13855_ofilm) / sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_slim_video_cactus_ov13855_ofilm[] = {
	0x0303, 0x03,
	0x3501, 0x20,
	0x3662, 0x08,
	0x3714, 0x30,
...
static void slim_video_setting(void) {
	cactus_ov13855_ofilm_table_write_cmos_sensor(addr_data_pair_slim_video_cactus_ov13855_ofilm, sizeof(addr_data_pair_slim_video_cactus_ov13855_ofilm) / sizeof(kal_uint16));
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) {
	...
	for (i = 0; imgsensor_info.i2c_addr_table[i] != 0xFF; i++) {
		...
		size = imgSensorReadEepromData(&sensor_eeprom_data, cactus_ov13855_ofilm_checksum, 16);
