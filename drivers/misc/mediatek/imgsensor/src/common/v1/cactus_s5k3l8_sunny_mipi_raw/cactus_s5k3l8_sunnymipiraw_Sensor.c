...
static struct stCAM_CAL_DATAINFO_STRUCT sensor_eeprom_data ={
	...
	.deviceID = 1,
	.dataLength = 0x1BF6,
	.sensorVendorid = 0x012E1809,
	.vendorByte = {1,8,9,10},
	.dataBuffer = NULL,
};
static struct stCAM_CAL_CHECKSUM_STRUCT s5k3l8Checksum[8] =
{
...
static kal_uint16 cactus_s5k3l8_table_write_cmos_sensor(
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_cactus_s5k3l8[] = {
	0x6028, 0x4000,
	0x6214, 0xFFFF,
	0x6216, 0xFFFF,
	0x6218, 0x0000,
...
static void sensor_init(void)
{
	...
	cactus_s5k3l8_table_write_cmos_sensor(
		addr_data_pair_init_cactus_s5k3l8,
		sizeof(addr_data_pair_init_cactus_s5k3l8) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_cactus_s5k3l8[] = {
	0x6028, 0x2000,
	0x602A, 0x0F74,
	0x6F12, 0x0040,
	0x6F12, 0x0040,
...
#if MULTI_WRITE
	cactus_s5k3l8_table_write_cmos_sensor(
		addr_data_pair_preview_cactus_s5k3l8,
		sizeof(addr_data_pair_preview_cactus_s5k3l8) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x6028, 0x2000);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_cactus_s5k3l8[] = {
	0x6028, 0x2000,
	0x602A, 0x0F74,
	0x6F12, 0x0040,
	0x6F12, 0x0040,
...
kal_uint16 addr_data_pair_capture_24fps_cactus_s5k3l8[] = {
	0x6028, 0x2000,
	0x602A, 0x0F74,
	0x6F12, 0x0040,
	0x6F12, 0x0040,
...
kal_uint16 addr_data_pair_capture_30fps_cactus_s5k3l8[] = {
	0x6028, 0x2000,
	0x602A, 0x0F74,
	0x6F12, 0x0040,
	0x6F12, 0x0040,
...
kal_uint16 addr_data_pair_capture_fps_cactus_s5k3l8[] = {
	0x6028, 0x2000,
	0x602A, 0x0F74,
	0x6F12, 0x0040,
	0x6F12, 0x0040,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
	cactus_s5k3l8_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_cactus_s5k3l8,
		sizeof(addr_data_pair_capture_15fps_cactus_s5k3l8) /
		sizeof(kal_uint16));
	} else if (currefps == 240) {
	cactus_s5k3l8_table_write_cmos_sensor(
		addr_data_pair_capture_24fps_cactus_s5k3l8,
		sizeof(addr_data_pair_capture_24fps_cactus_s5k3l8) /
		sizeof(kal_uint16));
	} else if (currefps == 300) {
	cactus_s5k3l8_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_cactus_s5k3l8,
		sizeof(addr_data_pair_capture_30fps_cactus_s5k3l8) /
		sizeof(kal_uint16));
	} else {
	cactus_s5k3l8_table_write_cmos_sensor(
		addr_data_pair_capture_fps_cactus_s5k3l8,
		sizeof(addr_data_pair_capture_fps_cactus_s5k3l8) /
		sizeof(kal_uint16));
	}
#else
	if (currefps == 300) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_cactus_s5k3l8[] = {
	0x6028, 0x2000,
	0x602A, 0x0F74,
	0x6F12, 0x0040,
	0x6F12, 0x0040,
...
#if MULTI_WRITE
	cactus_s5k3l8_table_write_cmos_sensor(
		addr_data_pair_hs_video_cactus_s5k3l8,
		sizeof(addr_data_pair_hs_video_cactus_s5k3l8) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x6028, 0x2000);
	write_cmos_sensor(0x602A, 0x0F74);
...
#define CACTUS_S5K3L8_SUNNY_I2CBUS    (2)
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	LOG_DBG("CACTUS_S5K3L8_SUNNY_I2CBUS = %d, I2C_bus = %d\n", CACTUS_S5K3L8_SUNNY_I2CBUS, I2C_bus);
	if (I2C_bus != CACTUS_S5K3L8_SUNNY_I2CBUS) {
		*sensor_id = 0xFFFFFFFF;
		LOG_ERR("CACTUS_S5K3L8_SUNNY_I2CBUS: %d, I2C_bus = %d, Check Error!\n", CACTUS_S5K3L8_SUNNY_I2CBUS, I2C_bus);
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		size = imgSensorReadEepromData(&sensor_eeprom_data,s5k3l8Checksum);
			...
			MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	int i=0;
	for(i=0; i<10; i++){
		LOG_DBG("delay time = %d, the frame no = %d\n", i*10, read_cmos_sensor(0x0005));
		mdelay(10);
	}
	#endif
	return ERROR_NONE;
