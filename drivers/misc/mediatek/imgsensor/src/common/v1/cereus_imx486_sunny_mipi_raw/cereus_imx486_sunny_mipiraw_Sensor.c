 ...
 * Filename:
 * ---------
 *	 cereus_imx486_sunny_mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	/* CEREUS_IMX486_SUNNY_MIPI_SENSOR_ID, sensor_id = 0x2680*/
...
static kal_uint16 cereus_imx486_table_write_cmos_sensor(
...
#define CEREUS_IMX486_SUNNY_MIPI_MaxGainIndex (193)
kal_uint16 CEREUS_IMX486_SUNNY_MIPI_sensorGainMapping[CEREUS_IMX486_SUNNY_MIPI_MaxGainIndex+1][2] = {
	{64, 0},
	{66, 16},
	{68, 30},
	{70, 44},
...
static struct stCAM_CAL_DATAINFO_STRUCT sensor_eeprom_data ={
	...
	.deviceID = 1,
	.dataLength = 0x1BF6,
	.sensorVendorid = 0x011B140A,
	.vendorByte = {1,8,9,10},
	.dataBuffer = NULL,
};

static struct stCAM_CAL_CHECKSUM_STRUCT imx486Checksum[9] =
{
...
(shutter < imgsensor_info.min_shutter) ? imgsensor_info.min_shutter : shutter;
	...
	LOG_DBG("shutter =%d,framelen =%d/%d,dummy_line=%d,autoextend=%d\n",
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	return reg_gain;
#else
	for (i = 0; i < CEREUS_IMX486_SUNNY_MIPI_MaxGainIndex; i++) {
		if (gain <= CEREUS_IMX486_SUNNY_MIPI_sensorGainMapping[i][0])
			break;
	}
	if (gain != CEREUS_IMX486_SUNNY_MIPI_sensorGainMapping[i][0])
		LOG_ERR("Gain mapping don't correctly:%d %d\n", gain,
			CEREUS_IMX486_SUNNY_MIPI_sensorGainMapping[i][0]);
	return CEREUS_IMX486_SUNNY_MIPI_sensorGainMapping[i][1];
#endif
}
...
#if 0
	/*      preview_setting  */
static void cereus_imx486_sunny_ImageQuality_Setting(void)
{
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_cereus_imx486[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x4979, 0x0d,
	0x3040, 0x03,
...
//From reg tool at 2018-1-6 16:54
	...
	cereus_imx486_table_write_cmos_sensor(
		addr_data_pair_init_cereus_imx486,
		sizeof(addr_data_pair_init_cereus_imx486) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_cereus_imx486[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x08,
...
#if MULTI_WRITE
	cereus_imx486_table_write_cmos_sensor(
		addr_data_pair_preview_cereus_imx486,
		sizeof(addr_data_pair_preview_cereus_imx486) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_cereus_imx486[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x10,
...
kal_uint16 addr_data_pair_capture_24fps_cereus_imx486[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x10,
...
kal_uint16 addr_data_pair_capture_30fps_cereus_imx486[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x10,
...
static void capture_setting(kal_uint16 curretfps, kal_uint8 pdaf_mode)
{
	...
	if (curretfps == 150) {
	cereus_imx486_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_cereus_imx486,
		sizeof(addr_data_pair_capture_15fps_cereus_imx486) /
		sizeof(kal_uint16));
	} else if (curretfps == 240) {
	cereus_imx486_table_write_cmos_sensor(
		addr_data_pair_capture_24fps_cereus_imx486,
		sizeof(addr_data_pair_capture_24fps_cereus_imx486) /
		sizeof(kal_uint16));
	} else {
	cereus_imx486_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_cereus_imx486,
		sizeof(addr_data_pair_capture_30fps_cereus_imx486) /
		sizeof(kal_uint16));
	}
#else
	if (curretfps == 150) {
...
{
	LOG_DBG("normal video currefps: %d\n", currefps);
#if MULTI_WRITE
	cereus_imx486_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_cereus_imx486,
		sizeof(addr_data_pair_capture_30fps_cereus_imx486) /
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_cereus_imx486[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x08,
...
#if MULTI_WRITE
	cereus_imx486_table_write_cmos_sensor(
		addr_data_pair_hs_video_cereus_imx486,
		sizeof(addr_data_pair_hs_video_cereus_imx486) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0112, 0x0A);
	write_cmos_sensor(0x0113, 0x0A);
...
{
	LOG_DBG("slim video E\n");
	preview_setting();
}

static void custom1_setting(void)
{
	LOG_DBG("custom1_setting E\n");
#if MULTI_WRITE
cereus_imx486_table_write_cmos_sensor(
	addr_data_pair_preview_cereus_imx486,
	sizeof(addr_data_pair_preview_cereus_imx486) /
...
#define CEREUS_IMX486_SUNNY_I2CBUS    (2)
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	LOG_DBG("CEREUS_IMX486_SUNNY_I2CBUS = %d, I2C_bus = %d\n", CEREUS_IMX486_SUNNY_I2CBUS, I2C_bus);
	if (I2C_bus != CEREUS_IMX486_SUNNY_I2CBUS) {
		*sensor_id = 0xFFFFFFFF;
		LOG_ERR("IMX486_BACK_AUX_I2CBUS: %d, I2C_bus = %d, Check Error!\n", CEREUS_IMX486_SUNNY_I2CBUS, I2C_bus);
	...
	s_DEVINFO_ccm->device_ic = "CEREUS_IMX486_SUNNY";
	...
	*/
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		size = imgSensorReadEepromData(&sensor_eeprom_data,imx486Checksum);
...
static kal_uint32 open(void)
{
	...
	LOG_INF("CEREUS_IMX486_SUNNY,MIPI 4LANE\n");
	/* sensor have two i2c address 0x6c 0x6d & 0x21 0x20,
	 * we should detect the module used i2c address
	 */
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
	...
	if (imgsensor_info.sensor_id != sensor_id) {
		LOG_ERR("Open sensor id fail id: 0x%x\n", sensor_id);
		return ERROR_SENSOR_CONNECT_FAIL;
	}
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		#if 0
		read_cereus_imx486_sunny_pdaf((kal_uint16) (*feature_data),
				 (char *)(uintptr_t) (*(feature_data + 1)),
				 (kal_uint32) (*(feature_data + 2)));
		#endif
		break;
	case SENSOR_FEATURE_SET_TEST_PATTERN:
		LOG_DBG("SENSOR_FEATURE_SET_TEST_PATTERN\n");
