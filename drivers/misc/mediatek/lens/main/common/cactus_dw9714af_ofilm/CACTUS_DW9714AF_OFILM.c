...
long CACTUS_DW9714AF_OFILM_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	switch (a_u4Command) {
...
int CACTUS_DW9714AF_OFILM_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
